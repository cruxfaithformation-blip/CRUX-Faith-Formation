...
.back-tab {
  ...
  padding: 0.3rem 0.6rem 0.4rem; cursor: pointer;
  border-bottom: 1.5px solid transparent; margin-bottom: -1px;
  transition: color 0.2s, border-color 0.2s; user-select: none;
}
.back-tab.active { color: rgba(200,150,255,0.9); border-bottom-color: rgba(200,150,255,0.6); }
.back-tab:hover:not(.active) { color: rgba(255,255,255,0.55); }
...
<div class="card-scene" id="cardScene">
  <div class="card-flipper">
    ...
    <!-- ══ FRONT FACE ══ -->
    <div class="card-face card-front card-holo" id="holoCard">
