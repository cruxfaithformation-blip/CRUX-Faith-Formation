...
// Tap front face → flip to back; disable front-face pointer events so back is fully interactive
...
scene.querySelector('.flip-back-btn').addEventListener('click', () => {
  isFlipped = false;
  flipper.style.transform = '';
...
// Tab switching — no stopPropagation needed; front face has pointer-events:none when back is showing
...
// Holo parallax on front face only
